                        ...
                        <div class="sign-in-from">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="commuterRadio" name="userTypeCommuter" class="custom-control-input" value="Commuters">
                                    <label class="custom-control-label" for="commuterRadio">Commuter</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="driverRadio" name="userTypeDriver" class="custom-control-input" value="Driver">
                                    <label class="custom-control-label" for="driverRadio">Driver</label>
                                </div>
                            </div>
