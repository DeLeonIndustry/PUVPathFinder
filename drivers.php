...
$sql_total = "SELECT COUNT(*) FROM accounts WHERE acctype='Driver'";
$result_total = $conn->query($sql_total);
$total_records = $result_total->fetch_array()[0];
$total_pages = ceil($total_records / $records_per_page);

$sql = "SELECT name, mname, lname, suffix, email, address, dob, contact, idtype, idno, acctype, status FROM accounts WHERE acctype='Driver'";
